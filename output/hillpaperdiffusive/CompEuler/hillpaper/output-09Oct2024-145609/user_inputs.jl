function user_inputs()
    inputs = Dict(
        ...
        #---------------------------------------------------------------------------
        :tend                 => 36000.0, # Total simulation duration in seconds (10 hours)
        :Δt                   => 5.0,      # Model time step in seconds for most processes
        #:diffusive_dt         => 2.5,      # Model time step in seconds for diffusive processes
        :ode_solver           => SSPRK54(),
        :ndiagnostics_outputs => 21,
        :output_dir           => "./output/hillpaperdiffusive",
        :case                 => "rtb",
        #:CL                   => NCL(),
